...
def test_add_padding(dummy_image):
    augmented_image_top = add_padding(image=dummy_image, side="top", number=10)
    augmented_image_bottom = add_padding(image=dummy_image, side="bottom", number=15)
    augmented_image_right = add_padding(image=dummy_image, side="right", number=20)
    augmented_image_left = add_padding(image=dummy_image, side="left", number=25)
