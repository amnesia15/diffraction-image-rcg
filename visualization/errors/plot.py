...
df4_relu = pd.read_csv('2048-1024-1024-512-512-256 (relu)\\'
                       'model_output\\errors.csv')
...
df4_tanh = pd.read_csv('2048-1024-1024-512-512-256 (tanh)\\'
                       'model_output\\errors.csv')
...
run_relu_1 = pd.read_csv('108-55 (relu)\\model_output\\'
                         'running_times.csv')['running times']
run_tanh_1 = pd.read_csv('108-55 (tanh)\\model_output\\'
                         'running_times.csv')['running times']
run_relu_2 = pd.read_csv('200-50-25 (relu)\\model_output\\'
                         'running_times.csv')['running times']
run_tanh_2 = pd.read_csv('200-50-25 (tanh)\\model_output\\'
                         'running_times.csv')['running times']
run_relu_3 = pd.read_csv('202-101-50-20 (relu)\\model_output\\'
                         'running_times.csv')['running times']
run_tanh_3 = pd.read_csv('202-101-50-20 (tanh)\\model_output\\'
                         'running_times.csv')['running times']
run_relu_4 = pd.read_csv('2048-1024-1024-512-512-256 (relu)\\model_output\\'
                         'running_times.csv')['running times']
run_tanh_4 = pd.read_csv('2048-1024-1024-512-512-256 (tanh)\\model_output\\'
                         'running_times.csv')['running times']

# Calculating means of running times for relu NNs and tanh NNs
n_groups = 4
means_running_relu = [run_relu_1.mean(),
                      run_relu_2.mean(),
                      run_relu_3.mean(),
                      run_relu_4.mean()]
means_running_tanh = [run_tanh_1.mean(),
                      run_tanh_2.mean(),
                      run_tanh_3.mean(),
                      run_tanh_4.mean()]
...
n_groups = 4
means_relu_mae = [df1_relu['MAE test'].mean(),
                  df2_relu['MAE test'].mean(),
                  df3_relu['MAE test'].mean(),
                  df4_relu['MAE test'].mean()]
means_tanh_mae = [df1_tanh['MAE test'].mean(),
